...
function MentorCard({ mentor, index }) {
  // This is a duplicate of the MentorCard from page.js. If you want to avoid duplication, you can import it instead.
...
export default function MentorsClient({ mentors, expertiseList }) {
